...
protected:
    ...
    void T_parse_base_patches(std::string filename, int N_patches,std::vector<LR_vector> &base_patches,  std::vector<LR_vector>  &a1_patches,  std::vector<LR_vector>  &a2_patches) {
